...
The axis list is also authoritative for presentation samples. The
`nidavellir samples --run-artifacts-dir <staging-directory>` command reads
...
and licensing must describe the actual project and trained checkpoint. A
concrete model specification belongs in the consuming project, not in this
generic package.
